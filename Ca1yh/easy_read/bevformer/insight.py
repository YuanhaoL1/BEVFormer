from Ca1yh.easy_read.bevformer.projects.mmdet3d_plugin.datasets.custom_script import load_data_instance
...
once_data = load_data_instance('/home/liyuanhao/CAINE/OpenSourceProjects/BEV/BEVFormer/Ca1yh/easy_read/bevformer/projects/mmdet3d_plugin/datasets/once_data_idx_103.pkl')
# print(once_data)
...
with torch.no_grad():
    ...
    for idx in range(len_queue_1):  # len_queue_1 = 2
        ...
        '''<<<此处实现了learned_positional_encoding forawrd操作'''
